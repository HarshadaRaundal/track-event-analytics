...
const { ANALYTIC_SESSION_ID, DEVICE_INFO, EVENT_TIMESTAMP, IS_SESSION_END_TRIGGERED, LOGIN_SESSION_ID, USER_ID, IP_ADDRESS, USER_LOCATION_DATA, AIRDROP_SESSION_TABS, } = const_1.STORAGE_KEYS;
const trackAnalytics = (eventName, eventAttributes) => {
    ...
    const filteredAnalyticsData = (0, helper_1.filteredAttributes)(Object.assign(Object.assign({ userId,
        loginSessionId, channel: "WEBSITE" }, analyticsData), { analyticSessionId, timestamp: new Date().getTime().toString() }));
