import { IAnalyticsEventIds } from "../types/types";

// TODO, remove extra Ids
export const PRODUCTION_EVENTS_NAME: IAnalyticsEventIds = {
  ...
  // Path to Pro
  Website_PathToPro_Menu_Item_Click: "199ae7b4-340c-4295-bcb1-da171874d197",
  Website_PathToPro_Home_Page_Sticky_Banner_Click:
    "f23590e8-0538-423c-b3f5-e7274a4a6cde",
...
export const STAGING_EVENTS_NAME: IAnalyticsEventIds = {
  ...
  // Path to Pro
  Website_PathToPro_Menu_Item_Click: "74cce855-a8b8-4060-a881-e2bf09e26733",
  Website_PathToPro_Home_Page_Sticky_Banner_Click:
    "dcfbcca8-fdd4-40d7-8eae-432f15faaaed",
