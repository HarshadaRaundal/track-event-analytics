...
exports.eventNamesStaging =
  ...
  exports.plateformAnalytics =
  exports.firebaseAnalytics =
    void 0;
...
var firebaseAnalytics = function (eventName, analyticsObject) {
  ...
  if (!eventId) {
    console.error(
      "Error from FirebaseAnalytics : Event Id is missing for ".concat(
        eventName,
        "."
      )
    );
  ...
  var analyticsData = __assign(__assign({}, analyticsObject), {
    eventId: eventId,
  });
  console.log(
    eventName,
    __assign(__assign({}, analyticsData), {
      eventName: eventName,
      eventId: eventId,
    })
  );
...
var plateformAnalytics = function (eventName, analyticsObject) {
      ...
      switch (_b.label) {
        case 0:
          ...
          eventId = isStaging
            ? exports.eventNamesStaging[eventName]
            : exports.eventNamesProduction[eventName];
          (_a = const_1.ANALYTICS_EVENTS.SESSION_EVENTS),
            (ANALYTIC_SESSION_START = _a.ANALYTIC_SESSION_START),
            (LOGIN_SUCCESSFUL = _a.LOGIN_SUCCESSFUL);
          CCP_MODAL_DATA = const_1.STORAGE_KEYS.CCP_MODAL_DATA;
          CCPModalData = (0, helper_1.getLocalStorageItem)(CCP_MODAL_DATA);
        ...
        case 1:
          ...
          handleCCPSessionTime = function (isNewSession) {
            ...
            if (isNewSession) {
              ...
              var isCPPShownInCurrentSession =
                parsedCCPModalData === null || parsedCCPModalData === void 0
                  ? void 0
                  : parsedCCPModalData.isCPPShownInCurrentSession;
              var sessionData = __assign(__assign({}, parsedCCPModalData), {
                showCCPAt: Math.floor(
                  (0, helper_2.addMinutesToEpoch)(sessionStartTine, 1)
                ),
                isCPPShownInPrevSession: isCPPShownInCurrentSession,
                isCPPShownInCurrentSession: false,
              });
              (0, helper_1.setLocalStorage)(
                CCP_MODAL_DATA,
          ...
          if (!eventId) {
            console.error(
              "Error from PlateformAnalytics : Event Id is missing for ".concat(
                eventName,
                "."
              )
            );
