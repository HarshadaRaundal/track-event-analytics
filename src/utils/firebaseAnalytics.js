...
exports.eventNamesStaging = exports.eventNamesProduction = exports.plateformAnalytics = exports.firebaseAnalytics = void 0;
...
var firebaseAnalytics = function (eventName, analyticsObject) {
    var isStaging = process.env.ENVIRONMENT === "Staging";
    //   const eventId = "oiuytre";
    var eventId = isStaging
        ? exports.eventNamesStaging[eventName]
        : exports.eventNamesProduction[eventName];
    if (!eventId) {
...
var plateformAnalytics = function (eventName, analyticsObject) { return __awaiter(void 0, void 0, void 0, function () {
    var baseURL, gameAccountId, platformGameId, isStaging, eventId, _a, ANALYTIC_SESSION_START, LOGIN_SUCCESSFUL, CCP_MODAL_DATA, CCPModalData, parsedCCPModalData, accessToken, handleCCPSessionTime, queryParams, filteredParams, url, response, result, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                CCPModalData = (0, helper_1.getLocalStorageItem)(CCP_MODAL_DATA) || "null";
                parsedCCPModalData = CCPModalData && JSON.parse(CCPModalData);
            ...
            case 1:
                ...
                handleCCPSessionTime = function (isNewSession) {
                    ...
                    if (isNewSession) {
                        ...
                        var sessionData = __assign(__assign({}, parsedCCPModalData), { showCCPAt: Math.floor((0, helper_2.addMinutesToEpoch)(sessionStartTine, 1)), isCPPShownInPrevSession: isCPPShownInCurrentSession, isCPPShownInCurrentSession: false });
                        (0, helper_1.setLocalStorage)(CCP_MODAL_DATA, JSON.stringify(sessionData));
                    }
                    else {
                        var sessionData = __assign(__assign({}, parsedCCPModalData), { showCCPAt: Math.floor((0, helper_2.addMinutesToEpoch)(sessionStartTine, 1)) });
                        (0, helper_1.setLocalStorage)(CCP_MODAL_DATA, JSON.stringify(sessionData));
                    }
                };
...
exports.eventNamesProduction = {
    Insufficientkcashoverlay_Buybutton_click: "a58adfb2-6815-42b7-a062-4fa5e4304925",
    ...
    Confirmkcashpurchase_confrimbutton_click: "6f61187a-ec95-45cd-a73e-8e62e776914a",
    ...
    "Time Spent on the offerwall guide overlay": "11bec5b5-4084-41cb-9763-d3606c119844",
    "Offerwall guide overlay closed": "c7ff4f55-e695-45dd-bc54-99f0c055a149",
    "Time Spent on the offerwall iframe page": "8cd10560-fd69-4e45-b4a8-436f3c53b537",
    ...
    GameDetailsOverlay_loginmethod_selected: "d98d04d5-dd46-4e97-9e4c-30479ea1a38f",
    GameDetailsOverlay_loginvalue_interaction: "2333542c-266a-417e-ab24-e59ff83395b7",
    GameDetailsOverlay_gamedetails_interaction: "fa332744-133a-4687-aad5-b1ad2bf78ebe",
    clanchiefreferraloverlay_clanchiefnumber_interaction: "42e7dc39-a2ab-4884-8767-cf23cea1fd8e",
    ...
    clanchiefreferraloverlay_crossicon_click: "5394b98e-b0f0-4299-8dbd-bee5a2b79ef2",
    clanchiefreferraloverlay_submit_click: "882e9fa4-cddc-43ed-9dff-1721cb6fbf62",
    questDetailspage_Pastsubmissions_click: "1cb6a493-43e7-4357-8721-6816fdb7e27a",
    ...
    Click_clan_creation_success_overlay_CTA: "519aa094-499f-421d-854b-86a1cb98c66e",
    ...
    Click_Delete_Clan_Deletion_Confirmation_Overlay: "7108a513-6d5b-4645-a29b-f4585616cae6",
    Click_Cancel_Clan_Deletion_Confirmation_Overlay: "91b05139-f76e-4f45-9f25-01a1a61297d5",
    ...
    Click_Leave_Clan_Leave_Confirmation_Overlay: "d24fc3ee-4697-4b75-8cf4-46c89c4d91ca",
    Click_Cancel_Clan_Leave_Confirmation_Overlay: "7e121ede-f300-4b1e-a259-3bdaf7be8250",
    ...
    Click_DeleteCTA_On_Delete_Clan_OTP_Overlay: "53448c06-c494-44b4-9508-0f1f27262191",
    ...
    Click_Leadearboard_Bottomsheet_Rewards_Button: "c6a28794-c353-4d34-9b7e-2e49ae7fb93e",
    ...
    Click_Leadearboard_Bottomsheet_Information_Button: "38e6eade-1b96-43b0-a8a7-1820b004a765",
    ...
    Click_Claim_CTA_On_Claim_Bonus_Overlay: "c611d533-f869-4431-abd2-be4a9c36b8b8",
    Click_Close_On_Claim_Bonus_Overlay: "f5af448a-6091-4b52-a950-40a5135ac03b",
    Click_Know_More_On_Claim_Bonus_Overlay: "5ac1f5a1-d128-408e-a37f-1253ce329bf8",
    ...
    Click_View_Details_Clan_Stats_Dashboard: "56fd4f91-4dfe-489d-adcd-9718b0c5f454",
    Click_Share_Quest_Clan_Stats_Dashboard: "6b83fde7-300a-4768-b978-32aa9c736e5f",
    ...
    Click_StartClan_On_CC_Promotion_Overlay: "6e9d2462-dc11-43fe-a1ef-7a98662422e4",
    ...
    overlay_twitter_recoonect_cross_button_click: "59b54e7e-541c-4550-ba93-04cc178cd8bb",
    //kgen corporate
...
exports.eventNamesStaging = {
    Insufficientkcashoverlay_Buybutton_click: "f1fe3603-5d3c-43c3-928e-397578c62884",
    ...
    Confirmkcashpurchase_confrimbutton_click: "10c3b4dd-496f-4ce2-8105-816c0351aa3d",
    ...
    "Time Spent on the offerwall guide overlay": "546f0a88-03e6-4fa5-9b7b-59ce1fe4841f",
    "Time Spent on the offerwall iframe page": "54995af5-de16-4b83-9889-75d11df4feee",
    ...
    GameDetailsOverlay_loginmethod_selected: "55917419-ff17-4599-bbd4-5a3b9b6f1816",
    GameDetailsOverlay_loginvalue_interaction: "bccbc356-ecc7-4993-85f7-1727ebe0e26f",
    GameDetailsOverlay_gamedetails_interaction: "1e8693a5-c8a7-42fe-bf1b-f7d9302d1724",
    clanchiefreferraloverlay_clanchiefnumber_interaction: "9b65032a-364c-4f52-b9ff-86c6205d6805",
    ...
    clanchiefreferraloverlay_crossicon_click: "a613e70f-6210-414f-85f0-febf98e004a6",
    clanchiefreferraloverlay_submit_click: "d13c5d88-6d7e-48e6-a3ed-5c68b817fa2d",
    questDetailspage_Pastsubmissions_click: "f42bdcc1-8ca9-4e46-b71f-81c2489c80bb",
    ...
    Click_clan_creation_success_overlay_CTA: "ba836cbf-5311-467f-b0d0-525c29e76bf0",
    ...
    Click_Delete_Clan_Deletion_Confirmation_Overlay: "ab446895-ce7b-414e-931a-690954e4c10d",
    Click_Cancel_Clan_Deletion_Confirmation_Overlay: "e74a920a-d7e8-4938-a6fe-d5993445e24d",
    ...
    Click_Leave_Clan_Leave_Confirmation_Overlay: "6fb3eba0-a5ae-475f-a826-bf13865d7714",
    Click_Cancel_Clan_Leave_Confirmation_Overlay: "b228a68c-77b0-4eeb-84ae-7710611891f3",
    ...
    Click_DeleteCTA_On_Delete_Clan_OTP_Overlay: "6eb446dd-965e-4191-91e9-b6690df2e417",
    ...
    Click_Leadearboard_Bottomsheet_Rewards_Button: "7c55dba5-a480-44b7-a672-dfc24fc7c251",
    ...
    Click_Leadearboard_Bottomsheet_Information_Button: "91032a0f-7b9a-448b-ac38-03e76a16d386",
    ...
    Click_Claim_CTA_On_Claim_Bonus_Overlay: "977948ae-80a9-4bf3-bbfd-1edfdfa11fd6",
    Click_Close_On_Claim_Bonus_Overlay: "b5cd2888-9186-40bc-981a-11f33e138c2c",
    Click_Know_More_On_Claim_Bonus_Overlay: "3d540775-1c0b-4ffd-9106-0bef00b56920",
    ...
    Click_View_Details_Clan_Stats_Dashboard: "56f4e980-ba9a-4561-ae6f-bf0a5e441743",
    Click_Share_Quest_Clan_Stats_Dashboard: "ea2b9d08-dc12-4489-96e8-6c852e3ceea1",
    ...
    Click_StartClan_On_CC_Promotion_Overlay: "bac59327-7932-4397-986c-5d40a1138234",
    ...
    overlay_twitter_recoonect_cross_button_click: "5d2a7ce3-6d82-4725-b465-55639dbcb919",
    //kgen corporate
